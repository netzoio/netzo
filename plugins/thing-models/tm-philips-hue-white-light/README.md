<div align="center">
  <a href="https://netzo.io" target="_blank" >
    <img height="50" src="https://raw.githubusercontent.com/netzoio/netzo/main/packages/plugins/plugins/thing-models/tm-philips-hue-white-light/src/assets/icon.png" style="margin: 12px 0px" />
  </a>

  <h1 style="padding: 6px 0px 24px 0px">tm-philips-hue-white-light</h1>
</div>
...
<p align="center">
<img width="600" src="https://raw.githubusercontent.com/netzoio/netzo/main/packages/plugins/plugins/thing-models/tm-philips-hue-white-light/src/assets/create-developer-hue-account.png" style="margin: 12px 0px" />
</p>
...
<p align="center">
<img width="600" src="https://raw.githubusercontent.com/netzoio/netzo/main/packages/plugins/plugins/thing-models/tm-philips-hue-white-light/src/assets/create-new-hue-remote-api-app.png" style="margin: 12px 0px" />
 </p>
...
5. Download the [Philips HUE Postman Collection](plugins/thing-models/tm-philips-hue-white-light/philips-hue-postmann-collection.json) and import it into your Postman client.
...
<p align="center">
<img width="600" src="https://raw.githubusercontent.com/netzoio/netzo/main/packages/plugins/plugins/thing-models/tm-philips-hue-white-light/src/assets/postman-add-variables.png" style="margin: 12px 0px" />
</p>
...
<p align="center">
<img width="1000" src="https://raw.githubusercontent.com/netzoio/netzo/main/packages/plugins/plugins/thing-models/tm-philips-hue-white-light/src/assets/get-authorization-request-error.png" style="margin: 12px 0px" />
</p>
...
<p align="center">
<img width="600" src="https://raw.githubusercontent.com/netzoio/netzo/main/packages/plugins/plugins/thing-models/tm-philips-hue-white-light/src/assets/get-authorization-code.png" style="margin: 12px 0px" />
</p>
...
13. If you haven't tken more than 30 seconds after the last request, send a "POST Post Add Whitelist Identifier". The responde should contain your apps {{ username }}. Add this to your Postman config for safekeeping. You will need this username to setup your devices in the Netzo WoT platform.
