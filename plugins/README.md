...
| ------------- | ------------------- | -------- | ---------------------------------------------------------------------------------------------------------------- |
| `uid`         | String              | true     | A unique ID (camel-case) prefixed by the initials of its the plugin type (`service-`, `source-`, `module` or `component`)                  |
| `type`        | String              | true     | Plugin type, one of `service`, `source`, `module` or `component`                                          |
